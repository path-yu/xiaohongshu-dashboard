"use client"
import { Box, Card, CardContent, CardMedia, Typography, Grid, Checkbox, Chip } from "@mui/material"
          ...
          <Card sx={{ position: "relative", height: "100%", display: "flex", flexDirection: "column" }}>
            <Box sx={{ position: "absolute", top: 8, left: 8, zIndex: 1 }}>
              <Checkbox
                ...
                onChange={() => handleToggleSelection(post)}
                sx={{
            ...
            <CardContent sx={{ flexGrow: 1 }}>
              ...
              <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                ...
                <Box sx={{ display: "flex", gap: 1 }}>
                  <Chip icon={<FavoriteIcon fontSize="small" />} label={post.likes} size="small" variant="outlined" />
                  <Chip icon={<CommentIcon fontSize="small" />} label={post.comments} size="small" variant="outlined" />
                </Box>
              </Box>
            </CardContent>
          </Card>
